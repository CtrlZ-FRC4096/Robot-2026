...
class Drivetrain(Subsystem):
    ...
    def create_launch_vel_table(self):
        ...
        self.vel_lookup_table.add_entry(6.0, 50) #empirical (1.65)
        self.vel_lookup_table.add_entry(6.53, 55) # empirical (2.4)
        self.vel_lookup_table.add_entry(7.3, 63) # empirical (3.35)
        self.vel_lookup_table.add_entry(8.1, 71) # empirical (4.25)
        self.vel_lookup_table.add_entry(7.75, 67) # empirical (3.88)
        self.vel_lookup_table.add_entry(7.85, 68) # empirical (3.99)
        self.vel_lookup_table.add_entry(8.63, 83) # empirical (4.88)
        
    def create_launch_angle_table(self):
        self.angle_lookup_table.add_entry(61, 45) # empirical (4.88)
        # self.angle_lookup_table.add_entry(61, 45) #empirical (4.25)
        # self.angle_lookup_table.add_entry(61, 44) # empirical (3.99)
        # self.angle_lookup_table.add_entry(61, 44) # empirical (3.88)
        self.angle_lookup_table.add_entry(61, 43) #empirical (3.35)
        self.angle_lookup_table.add_entry(63.9, 40) # empirical (2.4)
        # self.angle_lookup_table.add_entry(65, 40)
        self.angle_lookup_table.add_entry(69, 31) # empircal (1.65)
