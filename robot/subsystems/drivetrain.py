...
class Drivetrain(Subsystem):
    def __init__(self, robot: "Robot"):
        ...
        self.x_controller.setTolerance(0.4, 1) #0.025, 0.1
        self.y_controller.setTolerance(0.4, 1) #0.025, 0.1
    ...
    def create_lookup_table(self):
        ...
        self.dist_lookup_table.add_entry(0.7, 6.845, 83.539, 1.103)
        self.dist_lookup_table.add_entry(0.915, 6.876, 81.64, 1.103)
        self.dist_lookup_table.add_entry(1.129, 6.915, 79.76, 1.104)
        self.dist_lookup_table.add_entry(1.344, 6.962, 77.902, 1.104)
        self.dist_lookup_table.add_entry(1.559, 7.016, 76.072, 1.104)
        self.dist_lookup_table.add_entry(1.774, 7.078, 74.272, 1.105)
        self.dist_lookup_table.add_entry(1.988, 7.147, 72.506, 1.105)
        self.dist_lookup_table.add_entry(2.203, 7.224, 70.776, 1.106)
        self.dist_lookup_table.add_entry(2.418, 7.306, 69.084, 1.106)
        self.dist_lookup_table.add_entry(2.632, 7.396, 67.433, 1.107)
        self.dist_lookup_table.add_entry(2.847, 7.491, 65.823, 1.107)
        self.dist_lookup_table.add_entry(3.062, 7.593, 64.257, 1.108)
        self.dist_lookup_table.add_entry(3.276, 7.7, 62.733, 1.108)
        self.dist_lookup_table.add_entry(3.491, 7.812, 61.254, 1.109)
        self.dist_lookup_table.add_entry(3.706, 7.957, 61.0, 1.135)
        self.dist_lookup_table.add_entry(3.921, 8.149, 61.0, 1.174)
        self.dist_lookup_table.add_entry(4.135, 8.34, 61.0, 1.211)
        self.dist_lookup_table.add_entry(4.35, 8.529, 61.0, 1.248)
        self.dist_lookup_table.add_entry(4.565, 8.717, 61.0, 1.284)
        self.dist_lookup_table.add_entry(4.779, 8.904, 61.0, 1.319)
        self.dist_lookup_table.add_entry(4.994, 9.089, 61.0, 1.353)
        self.dist_lookup_table.add_entry(5.209, 9.272, 61.0, 1.387)
        self.dist_lookup_table.add_entry(5.424, 9.455, 61.0, 1.42)
        self.dist_lookup_table.add_entry(5.638, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(5.853, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(6.068, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(6.282, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(6.497, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(6.712, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(6.926, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(7.141, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(7.356, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(7.571, 9.55, 61.0, 1.437)
        self.dist_lookup_table.add_entry(7.785, 9.55, 61.0, 1.437)
