...
class Drivetrain(Subsystem):
    ...
    def create_lookup_table(self):
        ...
        self.dist_lookup_table.add_entry(0.7, 8.318, 85.758, 1.433)
        self.dist_lookup_table.add_entry(0.915, 8.334, 84.548, 1.433)
        self.dist_lookup_table.add_entry(1.129, 8.355, 83.342, 1.434)
        self.dist_lookup_table.add_entry(1.344, 8.379, 82.142, 1.434)
        self.dist_lookup_table.add_entry(1.559, 8.408, 80.949, 1.435)
        self.dist_lookup_table.add_entry(1.774, 8.44, 79.763, 1.435)
        self.dist_lookup_table.add_entry(1.988, 8.477, 78.586, 1.436)
        self.dist_lookup_table.add_entry(2.203, 8.517, 77.419, 1.436)
        self.dist_lookup_table.add_entry(2.418, 8.562, 76.263, 1.437)
        self.dist_lookup_table.add_entry(2.632, 8.61, 75.118, 1.437)
        self.dist_lookup_table.add_entry(2.847, 8.662, 73.986, 1.438)
        self.dist_lookup_table.add_entry(3.062, 8.717, 72.867, 1.439)
        self.dist_lookup_table.add_entry(3.276, 8.777, 71.762, 1.439)
        self.dist_lookup_table.add_entry(3.491, 8.839, 70.671, 1.44)
        self.dist_lookup_table.add_entry(3.706, 8.906, 69.595, 1.441)
        self.dist_lookup_table.add_entry(3.921, 8.975, 68.535, 1.441)
        self.dist_lookup_table.add_entry(4.135, 9.048, 67.491, 1.442)
        self.dist_lookup_table.add_entry(4.35, 9.125, 66.463, 1.443)
        self.dist_lookup_table.add_entry(4.565, 9.204, 65.451, 1.444)
        self.dist_lookup_table.add_entry(4.779, 9.287, 64.457, 1.445)
        self.dist_lookup_table.add_entry(4.994, 9.372, 63.479, 1.446)
        self.dist_lookup_table.add_entry(5.209, 9.461, 62.519, 1.446)
        self.dist_lookup_table.add_entry(5.424, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(5.638, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(5.853, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(6.068, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(6.282, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(6.497, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(6.712, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(6.926, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(7.141, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(7.356, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(7.571, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(7.785, 9.55, 61.594, 1.447)
        self.dist_lookup_table.add_entry(8.0, 9.55, 61.594, 1.447)
